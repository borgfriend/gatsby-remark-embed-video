...
it("proceses a twitch embed url", () => {
    ...
    expect((0, twitch_1.twitchIdProcessor)(exampleVideo)).toEqual({
        id: "v273436948",
        service: "twitch",
    });
});
...
it("proceses a twitch channel URL", () => {
    ...
    expect((0, twitch_1.twitchIdProcessor)(exampleChannel)).toEqual({
        id: "dakotaz",
        service: "twitchLive",
    });
});
...
it("returns undefined for random url", () => {
    expect((0, twitch_1.twitchIdProcessor)("http://youtube.com")).toEqual({});
});
